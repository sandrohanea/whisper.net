...
public class WhisperProcessorBuilder
{
  ...
  /// </summary>
  /// <param name="threads">The number of threads to be used during encoding and
  /// decoding.</param> <returns>An instance to the same builder.</returns>
  /// <remarks>
  ...
  /// <summary>
  /// Configures the processor with the max number of tokens to be used from the
  /// previous text as prompt for the decoder.
  /// </summary>
  /// <param name="maxLastTextTokens">The max number of tokens to be
  /// used.</param> <returns>An instance to the same builder.</returns>
  /// <remarks>
  ...
  /// <summary>
  /// Configures the processor with the start time in the audio from which it
  ...
  /// <summary>
  /// Configures the processor to not use past transformation (if any) as the
  /// initial prompt for a newer processing.
  /// </summary>
  /// <returns>An instance to the same builder.</returns>
  /// <remarks>
  ...
  /// <summary>
  /// Configures the processor to force a single segment as output instead of
  /// multiple.
  /// </summary>
  /// <returns>An instance to the same builder.</returns>
  /// <remarks>
  ...
  /// <summary>
  /// Configures the processor to print special tokens (e.g. &lt;SOT&gt;,
  /// &lt;EOT&gt;, &lt;BEG&gt;, etc.)
  /// </summary>
  /// <returns>An instance to the same builder.</returns>
  /// <remarks>
  ...
  /// <returns>An instance to the same builder.</returns>
  /// <remarks>
  /// This option is available only if <seealso cref="WithPrintResults"/> is
  ...
  /// <summary>
  /// Configures the processor to use the specified probability threshold for
  /// token timestamps.
  /// </summary>
  /// <param name="tokenTimestampsThreshold">Probability threshold to be used
  /// for token-level timestamps.</param> <returns>An instance to the same
  /// builder.</returns> <remarks> Default value is 0.01f. This option have
  ...
  /// <summary>
  /// Configures the processor to use the specified SUM probability threshold
  /// for token timestamps.
  /// </summary>
  /// <param name="tokenTimestampsSumThreshold">Probability SUM threshold to be
  /// used for token-level timestamps.</param> <returns>An instance to the same
  /// builder.</returns> <remarks> Default value is 0.01f. This option have
  /// effect only together with <seealso cref="WithTokenTimestamps"/>
  /// </remarks>
  public WhisperProcessorBuilder
  ...
  /// </summary>
  /// <param name="maxSegmentLength">The maximum segment length to be
  ...
  /// </summary>
  /// <param name="maxTokensPerSegment">The maximum number of tokens to be
  /// used</param> <returns>An instance to the same builder.</returns> <remarks>
  ...
  /// <summary>
  /// [EXPERIMENTAL] Configures the processor to speed up the audio 2x for
  /// faster recognition.
  /// </summary>
  /// <returns>An instance to the same builder.</returns>
  /// <remarks>
  ...
  /// <summary>
  ///  [EXPERIMENTAL] Configures the processor to override the audio context
  ///  size.
  /// </summary>
  ...
  /// <summary>
  /// [EXPERIMENTAL] Configures the processor to use an initial prompt, which
  /// will be prepended to any existing text context.
  /// </summary>
  ...
  /// <summary>
  /// Configures the processor to auto-detect the language based on initial
  /// samples.
  /// </summary>
  /// <returns>An instance to the same builder.</returns>
  /// <remarks>
  ...
  /// <summary>
  /// Configures the processor with a value indicating that the initial
  /// timestamp cannot be later than this.
  /// </summary>
  ...
  /// <summary>
  /// Configures the processor with a value indicating the length penalty
  /// (alpha).
  /// </summary>
  /// <param name="lengthPenalty">The initial max timestamp.</param>
  /// <returns>An instance to the same builder.</returns>
  /// <remarks>
  /// If not specified, the processor will use simple length normalization by
  ...
  /// </summary>
  /// <param name="temperature">The temperature to increase when falling
  /// back.</param> <returns>An instance to the same builder.</returns>
  /// <remarks>
  /// Falling back can happen when the decoding fails to meet either of the
  /// thresholds in: <seealso cref="WithEntropyThreshold(float)"/>, <seealso
  ...
  /// <summary>
  /// Configures the processor with a average log probability threshold over
  /// sampled tokens.
  /// </summary>
  /// <param name="logProbThreshold">The average log probability
  /// threshold.</param> <returns>An instance to the same builder.</returns>
  /// <remarks>
  ...
  /// <summary>
  /// Adds a <seealso cref="OnSegmentEventHandler"/> which will be called every
  /// time a new segment is detected.
  /// </summary>
  ...
  /// <summary>
  /// Adds a <seealso cref="OnProgressHandler"/> which will report the progress
  /// in percentage.
  /// </summary>
  ...
  /// <summary>
  /// Adds a <seealso cref="OnEncoderBeginEventHandler"/> which will be called
  /// when encoder will begin.
  /// </summary>
  ...
  /// <summary>
  /// Confiugres the processor to return probabilities during segment decoding
  /// <seealso cref="SegmentData.MaxProbability"/>, <seealso
  /// cref="SegmentData.MinProbability"/> and <seealso
