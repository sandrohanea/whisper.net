...
internal delegate void WhisperNewSegmentCallback(IntPtr ctx, IntPtr state,
                                                 int n_new, IntPtr user_data);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal delegate byte WhisperEncoderBeginCallback(IntPtr ctx, IntPtr state,
                                                   IntPtr user_data);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal delegate void WhisperProgressCallback(IntPtr ctx, IntPtr state,
                                               int progress, IntPtr user_data);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal delegate byte WhisperLogitsFilterCallback(IntPtr ctx, IntPtr state,
                                                   IntPtr tokens,
                                                   int tokens_count,
                                                   IntPtr logits,
                                                   IntPtr user_data);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal delegate void WhisperGgmlLogCallback(GgmlLogLevel level,
