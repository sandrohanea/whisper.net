...
linux_x64_vulkan:
	...
	echo $(VULKAN_SDK)
	ls -l $(VULKAN_SDK)
	ls -l $(VULKAN_SDK)/x86_64/lib
	ls -l $(VULKAN_SDK)/x86_64/include
	export Vulkan_LIBRARY=$(VULKAN_SDK)/x86_64/lib/libvulkan.so
	export Vulkan_INCLUDE_DIR=$(VULKAN_SDK)/x86_64/include
