BUILD_TYPE=Release
VERSION=1.4.0
CMAKE_TARGETS=-DCMAKE_BUILD_TYPE=$(BUILD_TYPE)
...
macos:
	rm -rf build/macos
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=MAC_UNIVERSAL -S . -B build/macos
...
ios:
	rm -rf build/ios
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=OS -S . -B build/ios
...
ios_64:
	rm -rf build/ios_64
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=OS64 -S . -B build/ios_64
...
maccatalyst_x64:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=MAC_CATALYST -S . -B build/maccatalyst_x64
...
maccatalyst_arm64:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=MAC_CATALYST_ARM64 -S . -B build/maccatalyst_arm64
...
ios_simulator_x64:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=SIMULATOR64 -S . -B build/ios_simulator_x64
...
ios_simulator_arm64:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=SIMULATORARM64 -S . -B build/ios_simulator_arm64
...
tvos_simulator_x64:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=SIMULATOR_TVOS -S . -B build/tvos_simulator_x64
...
tvos_simulator_arm64:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=SIMULATOR_TVOSARM64 -S . -B build/tvos_simulator_arm64
...
tvos:
	rm -rf build/tvos
	cmake $(CMAKE_TARGETS) -DCMAKE_TOOLCHAIN_FILE=ios.toolchain.cmake -DPLATFORM=TVOS -S . -B build/tvos
...
android_arm64-v8a:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_ANDROID_ARCH_ABI=arm64-v8a -DCMAKE_SYSTEM_NAME=Android -DCMAKE_ANDROID_API=21 -DCMAKE_ANDROID_NDK=$(NDK_PATH) -S . -B build/android-arm64-v8a
...
android_x86:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_ANDROID_ARCH_ABI=x86 -DCMAKE_SYSTEM_NAME=Android -DCMAKE_ANDROID_API=21 -DCMAKE_ANDROID_NDK=$(NDK_PATH) -S . -B build/android-x86
...
android_x64:
	...
	cmake $(CMAKE_TARGETS) -DCMAKE_ANDROID_ARCH_ABI=x86_64 -DCMAKE_SYSTEM_NAME=Android -DCMAKE_ANDROID_API=21 -DCMAKE_ANDROID_NDK=$(NDK_PATH) -S . -B build/android-x86_64
